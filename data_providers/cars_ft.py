...
from codebase.data_providers.autoaugment import StanfordCarsPolicy
...
class StanfordCarsFTDataProvider(DataProvider):
    ...
    def __init__(self, save_path=None, train_batch_size=32, test_batch_size=200, valid_size=None, n_worker=32,
        ...
        if not isinstance(self.image_size, int):
            raise TypeError("only support constant image size")
        else:
    ...
    def build_train_transform(self, image_size=None, print_log=True, auto_augment='rand-m9-mstd0.5'):
        ...
        train_transforms = transforms.Compose([
            transforms.Resize((244, 244), interpolation=3),  # BICUBIC interpolation
    ...
    def build_valid_transform(self, image_size=None):
        ...
        return transforms.Compose([
            transforms.Resize((244, 244), interpolation=3),

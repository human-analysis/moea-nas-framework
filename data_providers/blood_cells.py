...
class BloodCellsDataProvider(DataProvider):
    
    def __init__(self, save_path=None, train_batch_size=32, test_batch_size=512, valid_size=None, n_worker=4,
    ...
    def save_path(self):
        if self._save_path is None:
            self._save_path = '/mnt/datastore/blood_cells'  # home server
